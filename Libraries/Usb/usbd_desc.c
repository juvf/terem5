...
#define USBD_PID                        0x0115

/** @defgroup USB_String_Descriptors
  * @{
  */ 
#define USBD_LANGID_STRING              0x409
#define USBD_MANUFACTURER_STRING        "Interpribor"
#define USBD_PRODUCT_HS_STRING          "Terem5 in HS mode"
#define USBD_PRODUCT_FS_STRING          "Terem5 in FS Mode"
#define USBD_CONFIGURATION_HS_STRING    "Terem5 Config"
#define USBD_INTERFACE_HS_STRING        "Terem5 Interface"
#define USBD_CONFIGURATION_FS_STRING    "Terem5 Config"
#define USBD_INTERFACE_FS_STRING        "Terem5 Interface"
/**
  * @}
  */ 
