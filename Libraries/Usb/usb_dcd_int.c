...
const char *usb_txt[] = { "DCD_HandleOutEP_ISR",//0
						  ...
						  "DCD_IsoOUTIncomplete_ISR", //10
						  "DCD_SessionRequest_ISR",//11
						  "DCD_OTG_ISR",//12
                          "*** Enter ******************"//13
};
#endif
...
uint32_t USBD_OTG_ISR_Handler (USB_OTG_CORE_HANDLE *pdev)
{
  ...
  if (USB_OTG_IsDeviceMode(pdev)) /* ensure that we are in device mode */
  {
    ...
    {
#ifdef USB_DEBUG      
       //xQueueSendFromISR(cansolQueue, &usb_txt[5], 0);
#endif      
    ...
    {
#ifdef USB_DEBUG      
       xQueueSendFromISR(cansolQueue, &usb_txt[8], 0);
#endif      
    ...
    {
#ifdef USB_DEBUG      
       xQueueSendFromISR(cansolQueue, &usb_txt[9], 0);
#endif      
    ...
    {
#ifdef USB_DEBUG      
       xQueueSendFromISR(cansolQueue, &usb_txt[10], 0);
#endif      
...
#ifdef USB_DEBUG      
       xQueueSendFromISR(cansolQueue, &usb_txt[11], 0);
#endif
    }
...
#ifdef USB_DEBUG      
       xQueueSendFromISR(cansolQueue, &usb_txt[12], 0);
#endif
    }   
#endif    
  }
