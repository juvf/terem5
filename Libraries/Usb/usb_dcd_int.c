...
#include "osConfig.h"
//#define USB_DEBUG
const char *usb_txt[] = { "DCD_HandleOutEP_ISR",
						  "DCD_HandleInEP_ISR",
						  "USB_OTG_WRITE_REG32",
                                                  "modemismatch",
...
uint32_t USBD_OTG_ISR_Handler(USB_OTG_CORE_HANDLE *pdev)
{
	...
	if(USB_OTG_IsDeviceMode(pdev)) /* ensure that we are in device mode */
	{
		...
		{
#ifdef USB_DEBUG
			xQueueSendToBackFromISR(cansolQueue, (void*)&usb_txt[0], 0);
#endif
		...
		{
#ifdef USB_DEBUG
			xQueueSendToBackFromISR(cansolQueue, (void*)&usb_txt[1], 0);
#endif
...
#ifdef USB_DEBUG
			xQueueSendToBackFromISR(cansolQueue, (void*)&usb_txt[2], 0);
#endif
		}
...
#ifdef USB_DEBUG
                        xQueueSendToBackFromISR(cansolQueue, (void*)&usb_txt[3], 0);
#endif
		}
		...
		{
#ifdef USB_DEBUG
			xQueueSendToBackFromISR(cansolQueue, (void*)&usb_txt[4], 0);
#endif
...
#ifdef USB_DEBUG
			xQueueSendToBackFromISR(cansolQueue, (void*)&usb_txt[5], 0);
#endif
		}
...
#ifdef USB_DEBUG
			xQueueSendToBackFromISR(cansolQueue, (void*)&usb_txt[6], 0);
#endif
		}
...
#ifdef USB_DEBUG
			xQueueSendToBackFromISR(cansolQueue, (void*)&usb_txt[7], 0);
#endif
		}
...
#ifdef USB_DEBUG
			xQueueSendToBackFromISR(cansolQueue, (void*)&usb_txt[8], 0);
#endif
		}
...
#ifdef USB_DEBUG
			xQueueSendToBackFromISR(cansolQueue, (void*)&usb_txt[9], 0);
#endif
		}
...
#ifdef USB_DEBUG
			xQueueSendToBackFromISR(cansolQueue, (void*)&usb_txt[10], 0);
#endif
		}
#ifdef VBUS_SENSING_ENABLED
...
#ifdef USB_DEBUG
			xQueueSendToBackFromISR(cansolQueue, (void*)&usb_txt[11], 0);
#endif
		}
...
#ifdef USB_DEBUG
			xQueueSendToBackFromISR(cansolQueue, (void*)&usb_txt[12], 0);
#endif
		}
#endif    
	}
...
static uint32_t DCD_WriteEmptyTxFifo(USB_OTG_CORE_HANDLE *pdev, uint32_t epnum)
{
			...
			&& ep->xfer_len != 0)
	{
		...
		txstatus.d32 = USB_OTG_READ_REG32(
				&pdev->regs.INEP_REGS[epnum]->DTXFSTS);
	}
