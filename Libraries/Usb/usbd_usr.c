...
void USBD_USR_DeviceReset(uint8_t speed)
{
	...
	switch(speed)
	{
		case USB_OTG_SPEED_HIGH:
			mess = "USB Device Library v1.1.0 [HS]";
			/// LCD_LOG_SetFooter ("     USB Device Library v1.1.0 [HS]" );
			break;

		case USB_OTG_SPEED_FULL:
			/// LCD_LOG_SetFooter ("     USB Device Library v1.1.0 [FS]" );
			mess = "USB Device Library v1.1.0 [FS]";
			break;
		default:
			/// LCD_LOG_SetFooter ("     USB Device Library v1.1.0 [??]" );
			mess = "USB Device Library v1.1.0 [??]";

	}
	xQueueSendToBackFromISR(cansolQueue, (void* )&mess, 0);
}
...
///  LCD_UsrLog("> VCP Interface configured.\n");
	char *mess = "> VCP Interface configured.\n";
	xQueueSendToBackFromISR(cansolQueue, (void* )&mess, 0);
}
...
void USBD_USR_DeviceSuspended(void)
{
	...
	char *mess = "> USB Device in Suspend Mode.\n";
	xQueueSendToBackFromISR(cansolQueue, (void* )&mess, 0);
}
...
void USBD_USR_DeviceResumed(void)
{
	...
	/* Users can do their application actions here for the USB-Reset */
	char *mess = "> USB Device in Idle Mode.\n";
	xQueueSendToBackFromISR(cansolQueue, (void* )&mess, 0);
}
...
void USBD_USR_DeviceConnected(void)
{
	...
	char *mess = "> USB Device Connected.\n";
	xQueueSendToBackFromISR(cansolQueue, (void* )&mess, 0);
}
...
void USBD_USR_DeviceDisconnected(void)
{
	...
	char *mess = "> USB Device Disconnected.\n";
	xQueueSendToBackFromISR(cansolQueue, (void* )&mess, 0);
}
/**
 * @}
