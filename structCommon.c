...
uint64_t u64FromU8(const uint8_t *buffer)
{
	...
	result |= (((uint64_t)buffer[1] & 0xff) << 8);
	result |= (((uint64_t)buffer[2] & 0xff) << 16);
	result |= (((uint64_t)buffer[3] & 0xff) << 24);
	result |= (((uint64_t)buffer[4] & 0xff) << 32);
	result |= (((uint64_t)buffer[5] & 0xff) << 40);
	result |= (((uint64_t)buffer[6] & 0xff) << 48);
	result |= (((uint64_t)buffer[7] & 0xff) << 56);
	return result;
}
