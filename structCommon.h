...
enum
{
	...
	GT_SHT21,				//датчик температура и влажность ДПГ2.0
	GT_R4B,
	GT_R4C,
	GT_R4D,
	GT_R4E,
...
typedef struct
{
	float u; //измеренное знаечение в вольтах, с чётом поправочных коеф
	float p; //измеренное значение в еденицах измерения параметра
	float uClear; //измеренное знаечение в вольтах, без учёта поправочных коеф
} ResultMes;
